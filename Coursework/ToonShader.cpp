...
void ToonShader::setShaderParameters(ID3D11DeviceContext* deviceContext, const XMMATRIX &worldMatrix, const XMMATRIX &viewMatrix, 
	const XMMATRIX &projectionMatrix, ID3D11ShaderResourceView* texture, float screenWidth, float screenHeight)
{
	HRESULT result;
...
void ToonShader::render(ID3D11DeviceContext* deviceContext, int indexCount)
{
